...
namespace ElGamal.Models
{
    public class ElGamalManaged : ElGamal
    {
        ...
        public override byte[] DecryptData(byte[] p_data)
        {
            ...
            ElGamalDecryptor elgDecryptor = new ElGamalDecryptor(keyStruct);
            return elgDecryptor.ProcessData(p_data);
        }
        ...
        public override byte[] EncryptData(byte[] p_data)
        {
            ...
            ElGamalEncryptor elgDecryptor = new ElGamalEncryptor(keyStruct);
            return elgDecryptor.ProcessData(p_data);
        }
